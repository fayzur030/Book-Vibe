...
const BookDetailsPage = async ({ params }: DetailsProps) => {
  ...
  return (
    <div className='mx-auto grid max-w-7xl grid-cols-1 items-stretch gap-8 px-5 py-16 md:grid-cols-2'>
      {/* Left Side */}
      <div className='flex h-full min-h-137.35 items-center justify-center rounded-xl bg-[#F5F5F5]'>
        <Image
          src={book.image}
          alt={book.bookName}
          width={425}
      ...
      {/* Right Side */}
      <div className='flex h-full min-h-137.5 flex-col'>
        ...
        <div className='mt-5 border-y border-gray-200 py-3'>
          <p className='text-sm text-[#131313 ] md:text-base'>
            {book.category}
          </p>
        </div>
